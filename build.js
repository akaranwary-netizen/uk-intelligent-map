...
for(const f of ['index.html','style.css','app.js','traffic-live.js','navigation.js','navigation.css']){
...
console.log('Built UK Intelligent Map with live traffic + GPS navigation.');
