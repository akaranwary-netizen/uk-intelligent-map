...
for(const f of ['index.html','style.css','app.js','map-theme.js','traffic-live.js','navigation.js','navigation.css']){
...
console.log('Built UK Intelligent Map with branded TomTom navigation + live traffic + GPS navigation.');
